...
export const vendorService = {
  ...
  async addVendor(vendor: Omit<Vendor, 'id' | 'createdAt' | 'updatedAt'>): Promise<Vendor> {
    ...
    return mapVendorRowToVendor(data as VendorRow);
  },
  ...
  async getExpenses(): Promise<Expense[]> {
    ...
    return (data || []).map(item => mapExpenseRowToExpense(item as ExpenseRow));
  },
  ...
  async addExpense(expense: Omit<Expense, 'id' | 'createdAt' | 'updatedAt'>): Promise<Expense> {
    ...
    return mapExpenseRowToExpense(data as ExpenseRow);
  },
